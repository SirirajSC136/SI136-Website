            ...
            <div className="relative overflow-hidden bg-slate-800 py-24 text-center border-b border-slate-800">
                <div className="absolute top-0 left-0 w-full h-full z-0">
                    <div 
                        ...
                        style={{ animation: 'move-light-1 15s ease-in-out infinite', filter: 'blur(120px)'}}
                    />
                    <div 
                        className="absolute h-[400px] w-[400px] rounded-full bg-emerald-500/30"
                        style={{ animation: 'move-light-2 18s ease-in-out infinite alternate', filter: 'blur(100px)', right: 0, bottom: 0 }}
                    />
                </div>
