...
const Materials = () => {
	...
	const resourceSections = [
		...
		},
		{
			...
			links: [
				{ name: "SI135", href: "https://www.si135.com" },
				{ name: "SI134", href: "https://siriraj134.com/" },
				{
					name: "SI133",
					href: "https://sites.google.com/view/siriraj133official/",
				},
				{ name: "SI132", href: "https://sites.google.com/view/siriraj132/" },
				{
					name: "SI131",
					href: "https://sites.google.com/view/siriraj131official/",
				},
				{ name: "SI130", href: "https://sites.google.com/view/siriraj130/" },
			],
		},
		{
			title: "SMSU (สพศ.)",
			...
			links: [
				{
					...
					href: "https://guide.smsu.in.th/?fbclid=PAZXh0bgNhZW0CMTEAAad6Ris-c2JEvZ0ZJIgGcKk6iBY6nH5KC7v8-NdPcKPOyl847_0pUXESTSwXTA_aem_SC3yrdWx8Tle9h4rTyN_nw",
				},
				{ name: "IG SMSU", href: "https://www.instagram.com/smsusiriraj/" },
				{
					name: "IG PD (Personal Development)",
					href: "https://www.instagram.com/pdsiriraj/",
				},
				{
					name: "101 Research Guidebook",
					href: "https://drive.google.com/drive/folders/1-FcrdoYpiVwZCKjlQvcamLto4BTvLPhT",
				},
			],
		},
		{
			title: "SI136 Social Media Links",
			icon: <University size={24} />,
			links: [
				{
					name: "IG SI136",
					href: "https://www.instagram.com/siriraj136",
				},
				{
					name: "TikTok SI136",
					href: "https://www.tiktok.com/@siriraj136",
				},
			...
			<div className="container mx-auto px-4">
				<div className="text-center mb-12">
					...
					<p className="mt-2 text-lg text-secondary">
						A centralized hub for all your essential resources.
					</p>
				</div>
